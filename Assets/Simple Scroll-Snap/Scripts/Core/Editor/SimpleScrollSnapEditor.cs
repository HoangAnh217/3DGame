...
namespace DanielLochner.Assets.SimpleScrollSnap
{
    ...
    public class SimpleScrollSnapEditor : SSSCopyrightEditor
    {
        ...
        private SerializedProperty onBeginDragPanel;
        ...
        private void OnEnable()
        {
            ...
            onBeginDragPanel = serializedObject.FindProperty("onBeginDragPanel");
            #endregion
        }
        ...
        private void ShowEvents()
        {
            ...
            if (showEvents)
            {
                ...
                EditorGUILayout.PropertyField(onBeginDragPanel);
            }
        }
        #endregion
    }
