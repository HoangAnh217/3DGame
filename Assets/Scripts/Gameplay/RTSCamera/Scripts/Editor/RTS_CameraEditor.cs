...
namespace RTS_Cam
{
    ...
    public class RTS_CameraEditor : Editor
    {
        ...
        private void MovementTab()
        {
            ...
            if (camera.limitMap)
            {
                camera.limitMinX = EditorGUILayout.FloatField("LimitMin X: ", camera.limitMinX);
                camera.limitMaxX = EditorGUILayout.FloatField("LimitMax X: ", camera.limitMaxX);
                camera.limitMinZ = EditorGUILayout.FloatField("LimitMin Z: ", camera.limitMinZ);
                camera.limitMaxZ = EditorGUILayout.FloatField("LimitMax Z: ", camera.limitMaxZ);
            }
