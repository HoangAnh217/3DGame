...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        public float limitMinX = 50f; //x limit of map
        public float limitMaxX = 50f; //x limit of map
        public float limitMinZ = 50f; //z limit of map
        public float limitMaxZ = 50f; //z limit of map
        ...
        {
            get { return useKeyboardInput ? new Vector2(Input.GetAxis("Horizontal"), Input.GetAxis(verticalAxis)) : Vector2.zero; }
        }
        ...
        private void LimitPosition()
        {
            ...
            m_Transform.position = new Vector3(Mathf.Clamp(m_Transform.position.x, limitMinX, limitMaxX),
                ...
                Mathf.Clamp(m_Transform.position.z, limitMinZ, limitMaxZ));
        }
